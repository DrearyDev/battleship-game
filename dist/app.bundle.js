...
`, "",{"version":3,"sources":["webpack://./src/game.css"],"names":[],"mappings":";AACA;EACE,6BAA6B;EAC7B,0BAA0B;EAC1B,8BAA8B;;EAE9B,oBAAoB;EACpB,qBAAqB;;EAErB,mBAAmB;EACnB,qBAAqB;EACrB,6BAA6B;AAC/B;;AAEA;EACE,sBAAsB;EACtB,SAAS;AACX;;AAEA;EACE,aAAa;EACb,wEAAwE;EACxE,sCAAsC;EACtC,0BAA0B;AAC5B;AACA;EACE,0BAA0B;EAC1B,4BAA4B;EAC5B,0BAA0B;AAC5B;;AAEA;EACE,wBAAwB;EACxB,eAAe;EACf,aAAa;EACb,SAAS;AACX;AACA;EACE,mCAAmC;EACnC,0BAA0B;EAC1B,sCAAsC;EACtC,0BAA0B;AAC5B","sourcesContent":["\n:root {\n  --GRID_WIDTH: calc(50px * 10);\n  --GRID_BG_COLOR: lightblue;\n  --GRID_BORDER: 1px solid black;\n\n  --SQUARE_WIDTH: 50px;\n  --SQUARE_HEIGHT: 50px;\n\n  --SHIP_HEIGHT: 50px;\n  --SHIP_BG_COLOR: #aaa;\n  --SHIP_BORDER: 2px solid navy;\n}\n\nbody {\n  flex-direction: column;\n  gap: 50px;\n}\n\n.grid {\n  display: grid;\n  grid-template-columns: auto auto auto auto auto auto auto auto auto auto;\n  background-color: var(--GRID_BG_COLOR);\n  border: var(--GRID_BORDER);\n}\n.square {\n  width: var(--SQUARE_WIDTH);\n  height: var(--SQUARE_HEIGHT);\n  border: var(--GRID_BORDER);\n}\n\n.ships {\n  width: var(--GRID_WIDTH);\n  flex-wrap: wrap;\n  display: flex;\n  gap: 10px;\n}\n.ship {\n  /* width determined in javascript */\n  height: var(--SHIP_HEIGHT);\n  background-color: var(--SHIP_BG_COLOR);\n  border: var(--SHIP_BORDER);\n}\n"],"sourceRoot":""}]);
// Exports
